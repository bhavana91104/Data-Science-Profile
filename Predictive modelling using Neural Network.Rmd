...
grid <-expand.grid(.size = seq(5,20,5), .decay = seq(0.1,0.5,0.1)) #grid
...
#import the new data
new_car_seat_seat_sales <- read.csv("/cloud/project/data/new_car_seat_sales_data.csv")
#View(new_car_seat_seat_sales)

#apply the neural network model to the new data
NeuralNet_predict <- predict(NeuralNet, newdata=new_car_seat_seat_sales)
NeuralNet_predict
